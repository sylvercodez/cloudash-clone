...
import Favicon from "./landingpage/favicon";
  ...
  return (
    <>
      ...
      <hr className="my-3 md:my-6 border-gray-200 sm:mx-auto lg:my-8 " />
          <div className="grid xs:grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-1">
            <div className="mb-6 md:mb-0 col-span-2">
              <a href="" className="flex items-center">
                <Favicon />
              </a>
              <p className="text-sm pt-10">
                Access CloudWatch logs and metrics, hassle-free.
              </p>
              <div className="flex pt-10">
              
              <a
                href="#"
                className="text-gray-500 hover:text-gray-900 mr-3 dark:hover:text-white"
              >
                <svg
                  className="w-8 h-8"
                  fill="currentColor"
            ...
            <div className="col-span-2">
              ...
              <ul className="text-grey-2 ">
                ...
                <li className="mb-3">
                  <a href="#" className="hover:underline">
                    10 CloudWatch Logs Insights examples
                  </a>
                </li>
                <li className="mb-3">
                  <a href="#" className="hover:underline">
